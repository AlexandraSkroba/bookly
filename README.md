...
7. If you completed working on PR, then move jira ticket to `Code Review`.
9. If someone left comments in PR, then if ticket is in `Code Review` status, then he/she should move ticket to `Respond to Review`
10. When PR author solved all comments(made changes in code or replied to comments), then he should move ticket to `Code Review`
11. Once the PR is approved, move the ticket to Done, merge the branch into develop, then merge develop into main and push the code to production.
